                                ...
                                <table className="w-full text-sm">
                                    <thead className="bg-muted/50 text-left">
                                        <tr>
                                            ...
                                            <th className="px-2 py-1 text-right">Instancias</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {dispositivosMasUsados.map((d, idx) => (
                                            <tr key={idx} className="border-b last:border-0">
                                                ...
                                                <td className="px-2 py-1 text-muted-foreground">{d.marca || "N/A"}</td>
                                                <td className="px-2 py-1 text-right font-semibold text-primary">{d.count}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
